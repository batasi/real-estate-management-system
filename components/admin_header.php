<header class="header">
   ...
   <nav class="navbar">
      ...
      <a href="post_property.php"><i class="fas fa-building"></i><span>Post Property</span></a>
      <a href="listings.php"><i class="fas fa-building"></i><span>Listings</span></a>
      <a href="payment.php"><i class="fas fa-building"></i><span>Paid Property</span></a>
      <a href="users.php"><i class="fas fa-user"></i><span>Users</span></a>
      <a href="admins.php"><i class="fas fa-user-gear"></i><span>Agents</span></a>
