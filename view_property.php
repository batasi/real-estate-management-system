   ...
   <div class="details">
     <div class="swiper images-container">
         <div class="swiper-wrapper">
            <img src="admin/uploaded_files/<?= $fetch_property['image_01']; ?>" alt="" class="swiper-slide">
            <?php if(!empty($fetch_property['image_02'])){ ?>
            <img src="admin/uploaded_files/<?= $fetch_property['image_02']; ?>" alt="" class="swiper-slide">
            <?php } ?>
            <?php if(!empty($fetch_property['image_03'])){ ?>
            <img src="admin/uploaded_files/<?= $fetch_property['image_03']; ?>" alt="" class="swiper-slide">
            <?php } ?>
            <?php if(!empty($fetch_property['image_04'])){ ?>
            <img src="admin/uploaded_files/<?= $fetch_property['image_04']; ?>" alt="" class="swiper-slide">
            <?php } ?>
            <?php if(!empty($fetch_property['image_05'])){ ?>
            <img src="admin/uploaded_files/<?= $fetch_property['image_05']; ?>" alt="" class="swiper-slide">
            <?php } ?>
         </div>
      ...
      <div class="info">
         <p>KSH <span><?= $fetch_property['price']; ?></span></p>
      ...
      <div class="flex">
         <div class="box">
            ...
            <p><i>deposit amount : </i><span>KSH<span style="margin-right: .5rem;"></span><?= $fetch_property['deposite']; ?></span></p>
      ...
      <form action="" method="post" class="flex-btn">
         ...
         <a href="pay_now.php?get_id=<?= $fetch_property['id']; ?>" class="btn">Pay</a>
      </form>
   </div>
   <?php
      }
